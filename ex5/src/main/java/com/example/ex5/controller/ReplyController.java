...
public class ReplyController {
  ...
  @PutMapping(value = {"", "/"})      //putmapping은 업데이트할때 사용함.
  public ResponseEntity<String> modify(@RequestBody ReplyDTO replyDTO) {
    log.info(">>>" + replyDTO);
    replyService.modify(replyDTO);
    return new ResponseEntity<>(replyDTO.getRno() + "번 댓글 수정되었습니다", HttpStatus.OK);
  }
  ...
  public ResponseEntity<String> delete(@RequestBody ReplyDTO replyDTO) {
    ...
    return new ResponseEntity<>(replyDTO.getRno() + "번 댓글 삭제되었습니다", HttpStatus.OK);
  }
}
